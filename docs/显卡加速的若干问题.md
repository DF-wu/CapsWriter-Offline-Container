...
- 弃用 Vulkan，改用 CUDA 加速。确保安装 CUDA 驱动后，前往 llama.cpp [Releases / b10621](https://github.com/ggml-org/llama.cpp/releases/tag/b10621) 页面，下载 CUDA 发行包，将其 dll 替换到 `core/server/engines/llama` 文件夹里。
...
![RTX 5050 启用显存预加速前后，Qwen3-ASR 短句延迟由约 300 毫秒降至约 100 毫秒](../assets/Qwen3-ASR-短句超低延迟.png)
