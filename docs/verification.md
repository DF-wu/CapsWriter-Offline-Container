...
|---|---|---|
| CLI | `python client/cli/scripts/verify.py` | CLI syntax, health/readiness/models calls, multipart upload including filename escaping, mock HTTP transcription, HTTP error diagnostics, output files, Linux/Windows TTS command selection, zipapp packaging |
