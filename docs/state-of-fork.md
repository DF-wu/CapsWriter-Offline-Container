...
| | |
|---|---|
| 修改的 upstream-tracked 檔案 | **15**：`.gitignore`、`readme.md`、`requirements-server.txt`、`LLM/default.py`、`assets/BUILD_GUIDE.md`、`zip_release.py`、`core/client/hotword/hotword_standalone.py`、`core/client/transcribe/media_tool.py`、`core/client/transcribe/file_transcriber.py`、`core/server/engines/qwen_asr_gguf/inference/audio.py`、`core/server/engines/force_aligner_gguf/inference/audio.py`、`core/server/engines/sensevoice_onnx/inference/audio.py`、`core/server/engines/fun_asr_gguf/inference/audio.py`、`core/server/worker/gpu_boost.py`、`core/tools/window_detector.py` |
