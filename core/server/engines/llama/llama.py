"""
llama.cpp b7798 的 ctypes Python 绑定封装。

The fork pins verified b7798 libraries for every engine. Struct layouts and
penalty sampler arguments must match those assets; b10621 is ABI-incompatible.
"""
