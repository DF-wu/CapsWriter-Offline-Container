...
| 🔄 **易跟進上游** | 主要加值都在新增目錄；目前只有 22 個 upstream-tracked 檔案有刻意差異，並已在同步 SOP 中列明。詳見 [docs/architecture.md](docs/architecture.md) |
