...
ALLOWED_UPSTREAM_DIVERGENCE = frozenset(
    {
        ...
        # Reviewed regressions in the upstream refresh (PRs 4 and 5).
        "build-client.spec",
        "core/client/app.py",
        "core/client/transcribe/result_handler.py",
        "core/logger.py",
        "core/server/engines/qwen_asr_gguf/inference/asr.py",
        "core/server/engines/qwen_asr_gguf/inference/schema.py",
        "core/server/worker/check_model.py",
        "core/tools/chinese_itn/replacer.py",
        "core/tools/chinese_itn/sequence_parser.py",
        "core/tools/signal_handler.py",
        "core/tools/srt_from_txt.py",
        "build.spec",
        "core/__init__.py",
